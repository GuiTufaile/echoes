<?php 
    ...
    if($db->consulta_registros() == 1){
        ...
        if($valida){
            ...
            $db->alterar_dados('credenciados', $credenciado, "credenciado_id = ".$useraccred);
            header("Location: ".ROOT_WEB."/configuracoes/dados/index.php?editar=sucesso");
        } else{
            header("Location: ".ROOT_WEB."/configuracoes/dados/index.php?editar=erro");
        }
